...
impl InputDeviceRelativeAxisManager for InputDeviceRelativeAxisManagerImpl {
    ...
    fn create_input_device_relative_axis(&self, device: &Device, input_device_entity_instance: Arc<ReactiveEntityInstance>, relative_axis: RelativeAxisType) {
        ...
        match input_device_relative_axis {
            Ok(input_device_relative_axis) => {
                ...
                self.create_relative_axis_event(input_device_entity_instance.clone(), input_device_relative_axis.clone());
            }
            Err(_) => {
